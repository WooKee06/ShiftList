...
import OperationPlace from "../../../../assets/img/Operation/OperationShifts.png";
import OperationBox from "../../../../assets/img/Operation/OperationBox.png";

const Lists = () => {
  return (
    <div className={s.lists}>
      {/* <h3>Список операций</h3>
      <p>Здесь будут активные списки работников.</p> */}

      <ul>
        <li>
          <img src={OperationPlace} alt="" />
          <div>
            <section>
              <small>Приёмка СОРТ</small>
              <span>01</span>
            </section>
            <img src={OperationBox} alt="" />
          </div>
          <button>Ц.И</button>
        </li>
        <li>
